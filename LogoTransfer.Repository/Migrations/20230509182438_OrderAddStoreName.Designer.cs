...
namespace LogoTransfer.Repository.Migrations
{
    ...
    [Migration("20230509182438_OrderAddStoreName")]
    partial class OrderAddStoreName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogoTransfer.Core.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("OrderTransactionNo")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LogoTransfer.Core.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 5, 9, 21, 24, 37, 815, DateTimeKind.Local).AddTicks(7118),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 5, 9, 21, 24, 37, 815, DateTimeKind.Local).AddTicks(7121),
            ...
            modelBuilder.Entity("LogoTransfer.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 5, 9, 21, 24, 37, 815, DateTimeKind.Local).AddTicks(8179),
